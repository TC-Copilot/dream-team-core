...
$include = @('INSTALL-WITH-SCOUT.md','install.ps1','compatibility.ps1','preflight.ps1','verify-clean.ps1','package-share.ps1','release-guards.ps1','README.md','CHANGELOG.md','LICENSE','manifest.json','.gitignore','app','skills','automations','config','docs','test')
