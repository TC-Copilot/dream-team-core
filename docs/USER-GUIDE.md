...
is private preparation only. Creating a document does **not** approve or send the related email,
Teams message, publication, or share; those actions still wait at the normal approval gate.
